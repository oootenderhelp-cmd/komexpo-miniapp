...
Все защищённые процедуры требуют аутентификации через Manus OAuth. Текущий пользователь доступен как `ctx.user` в серверных процедурах.
...
- Комиссия платформы (20%) вычисляется автоматически при завершении заказа
...
5. Средства выпускаются подрядчику минус 20% комиссия платформы

## Commission Structure

- **Комиссия платформы:** 20% от суммы заказа
